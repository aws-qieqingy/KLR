...
if (!obj || PyTuple_SetItem(tup, 0, obj) == -1) return NULL;
}
{
PyObject *obj = Nat_topy(x->column);
if (!obj || PyTuple_SetItem(tup, 1, obj) == -1) return NULL;
}
{
PyObject *obj = Nat_Option_topy(x->lineEnd);
if (!obj || PyTuple_SetItem(tup, 2, obj) == -1) return NULL;
}
{
PyObject *obj = Nat_Option_topy(x->columnEnd);
if (!obj || PyTuple_SetItem(tup, 3, obj) == -1) return NULL;
}
...
if (!obj || PyTuple_SetItem(tup, 4, obj) == -1) return NULL;
}
